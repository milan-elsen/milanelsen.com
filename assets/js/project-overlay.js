(function () {
  var FALLBACK_OVERLAY_TEMPLATE = [
    ...
    '  <div class="project-overlay-lightbox-stage"><button class="project-overlay-close" type="button" aria-label="Close image preview" data-overlay-lightbox-close>&times;</button><img class="project-overlay-lightbox-image" data-overlay-lightbox-image loading="lazy" decoding="async" src="" alt=""><p class="project-overlay-lightbox-caption" data-overlay-lightbox-caption hidden></p></div>',
    "</div>",
  ].join("\n");
